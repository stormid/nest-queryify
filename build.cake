    ...
    .Does(() => 
{
    ...
    CopyFile("./src/Nest.Queryify/bin/" +configuration +"/Nest.Queryify.xml", buildOutput +"/Nest.Queryify.xml");
    ...
    .Does(() => 
{
        var settings = new NuGetPackSettings {
            ...
            Files = new[] {
                ...
                new NuSpecContent { Source = "Nest.Queryify.xml", Target = "lib/net45" },
